      ...
      <>
        ...
        {localStorage.itemCar.length > 2 ? (
          <div className="container">
            ...
            <div>
              {infoFromLocalStorage.map((product, index) => (
                <CarItem key={index} data={product} />
              ))}
            </div>
          ...
          <div className="container containerVacioCarrito">
