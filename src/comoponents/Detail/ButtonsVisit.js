...
export default function ButtonsVisit({ id }) {
  ...
  return (
    <div className="boxBotonesDetalle">
      <button
        className="botones_contador_detail_menos"
        onClick={(e) => handleContador(e)}
        value="menos"
      >
        {" "}
        -{" "}
      </button>
      <div className="contador_carrito">{contador}</div>
      <button
        className="botones_contador_detail_mas"
        onClick={(e) => handleContador(e)}
        value="mas"
      >
        +
      ...
      <div>
        <Link to={"/detailVisit/" + id} id="click">
          <button
            className="botonIncSesDetail"
            onClick={(e) => handleCompar(e)}
          >
            Comprar
          </button>
        </Link>
      ...
      <div>
        <button className="botonRegistroDetail" onClick={() => addToCar(id)}>
          Agregar al carrito
        </button>
      </div>
    </div>
