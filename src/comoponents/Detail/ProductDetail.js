...
<div class="modal fade" id="imagenModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      <img className="imagenModal" src={producto.image[1] ? producto.image[1] : cuadroBlanco} alt='imagenProducto'/>
      </div>     
    </div>
  </div>
</div>
...
<a data-bs-toggle="modal" data-bs-target="#imagenModal3">
  <img className="imagenSecundaria" src={producto.image[2] ? producto.image[2] : cuadroBlanco} alt='imagenProducto'/>
</a>
<div class="modal fade" id="imagenModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      <img className="imagenModal" src={producto.image[2] ? producto.image[2] : cuadroBlanco} alt='imagenProducto'/>
      </div>     
    </div>
  </div>
</div>
